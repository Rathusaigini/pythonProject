...
while True:
    ...
    print(" Part 4: ")
    for i in range(len(progress_outcome)):#using for loop and repeating for the number of count we get progress outcome
          t="{}:{}-{},{},{}".format(UoW_num[i],progress_outcome[i],pass_cre[i], defer_cre[i], fail_cre[i])#accessing the elements of all the lists orderly
          print(t, end=" ")#printing those elements in given formet t
          f.close()
